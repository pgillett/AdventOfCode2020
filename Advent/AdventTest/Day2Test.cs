...
namespace AdventTest
{
    ...
    public class Day2Test
    {
        ...
        [TestMethod]
        [DataRow("2-3 a: abc", false)]
        [DataRow("2-3 a: abac", true)]
        [DataRow("2-3 a: abacada", false)]
        ...
        [DataRow("2-3 a: abc", false)]
        [DataRow("2-3 a: abac", true)]
        [DataRow("2-3 a: bac", true)]
        [DataRow("2-3 a: baa", false)]
        ...
        private string _input = @"1-8 n: dpwpmhknmnlglhjtrbpx
